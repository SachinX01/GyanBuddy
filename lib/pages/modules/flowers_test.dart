...
class FlowersTestPage extends StatefulWidget {
  const FlowersTestPage({super.key});
...
class _FlowersTestPageState extends State<FlowersTestPage> {
  ...
  void _shuffleQuestions() {
    questions =
        (List<FlowerQuestion>.from(allQuestions)..shuffle()).take(5).toList();
  }
  ...
  void _showFinalScore(BuildContext context) async {
    ...
    await userDataService.saveQuizResult(
        'Flowers', correctAnswers, questions.length);
    bool wasCompleted = await userDataService.isModuleCompleted('Flowers');
    await userDataService.checkAndCompleteModule(
        'Flowers', correctAnswers, questions.length);
    bool isNowCompleted = await userDataService.isModuleCompleted('Flowers');
              ...
              Text(
                isNowCompleted
                    ? wasCompleted
                        ...
                        : 'Congratulations! You\'ve completed the Flowers module.'
