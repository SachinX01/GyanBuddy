...
class PlanetsTestPage extends StatefulWidget {
  const PlanetsTestPage({super.key});
...
class _PlanetsTestPageState extends State<PlanetsTestPage> {
  ...
  void _shuffleQuestions() {
    questions =
        (List<PlanetQuestion>.from(allQuestions)..shuffle()).take(5).toList();
  }
  ...
  void _showFinalScore(BuildContext context) async {
    ...
    await userDataService.saveQuizResult(
        'Planets', correctAnswers, questions.length);
    bool wasCompleted = await userDataService.isModuleCompleted('Planets');
    await userDataService.checkAndCompleteModule(
        'Planets', correctAnswers, questions.length);
    bool isNowCompleted = await userDataService.isModuleCompleted('Planets');
              ...
              Text(
                isNowCompleted
                    ? wasCompleted
                        ...
                        : 'Congratulations! You\'ve completed the Planets module.'
