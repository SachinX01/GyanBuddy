...
class _AnimalsTestPageState extends State<AnimalsTestPage> {
  ...
  void _shuffleQuestions() {
    questions =
        (List<AnimalQuestion>.from(allQuestions)..shuffle()).take(5).toList();
  }
  ...
  void _showFinalScore(BuildContext context) async {
    ...
    await userDataService.saveQuizResult(
        'Animals', correctAnswers, questions.length);
    bool wasCompleted = await userDataService.isModuleCompleted('Animals');
    await userDataService.checkAndCompleteModule(
        'Animals', correctAnswers, questions.length);
    bool isNowCompleted = await userDataService.isModuleCompleted('Animals');
              ...
              Text(
                isNowCompleted
                    ? wasCompleted
                        ...
                        : 'Congratulations! You\'ve completed the Animals module.'
