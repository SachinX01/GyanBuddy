...
import 'package:gyanbuddy/utils/functions.dart';
...
class _PopupDialogState extends State<_PopupDialog> {
  ...
  Future<void> _speakDescription() async {
    ...
    // Set language
    await flutterTts.setLanguage("en-IN");
    // Set speech rate (0.4 is slower, adjust as needed)
    await flutterTts.setSpeechRate(0.5 );
    // Optional: Set pitch for a more kid-friendly tone (1.0 is normal)
    await flutterTts.setPitch(1);
    // Ensure it waits for each utterance to complete
