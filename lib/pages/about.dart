...
/*              const SizedBox(height: 32.0),
              ...
              _buildFeature(
                context,
                'Animals',
                'Discover animals, hear their sounds, and buddy how to pronounce their names, fostering a love for nature and wildlife.',
              ),
              _buildFeature(
                context,
                'Body Parts',
              ...
              Row(
                children: [
                  _buildIcon(context, 'https://github.skn/SachinX01',
                      'assets/images/github.svg'),
                  const SizedBox(width: 16.0),
                  _buildIcon(context, 'mailto:sachinkumarnishad321@gmail.skn',
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFeature(
              context,
              'A-Z Alphabets',
              'Each letter of the alphabet is accompanied by an example image and pronunciation guide. Children can interact with the letters to hear how they sound, helping them to buddy the alphabet in a fun and engaging way.',
            ),
            _buildFeature(
              context,
              'Animals',
              'The animals section introduces children to various animals, providing sounds and fun facts about each one. This feature helps children to develop a love for nature and buddy more about the animal kingdom.',
            ),
            _buildFeature(
              context,
              'Body Parts',
              'This feature includes a diagram of the human body with clickable parts that provide information and pronunciation. It helps children to buddy about their own bodies and understand the function of each part.',
            ),
            
            _buildFeature(
              context,
              'Birds',
              'The upcoming birds section will introduce various birds and their calls, helping children to recognize and buddy more about avian species.',
            ),
            _buildFeature(
              context,
              'Solar System',
            ...
            _buildFeature(
              context,
              'Shapes',
              'Children will buddy about different shapes and their properties, which helps in developing cognitive and visual-spatial skills.',
            ),
            const SizedBox(height: 16.0),
            ...
            _buildSectionContent(
              context,
              'We value your feedback! If you have any suggestions or issues, please contact us at sachinkumarnishad321@gmail.skn or through our social media channels.',
            ),
          ],
        ),
      ),
