        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  if (AppConstants.ques[questionnumber].image != null)
                    _buildImage(AppConstants.ques[questionnumber].image!),
                  const SizedBox(
                    height: 10,
                  ),
                  Text(
                ...
                if (questionnumber < AppConstants.ques.length - 1) {
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      ...
                      userDataService.saveQuizResult(
                          'General Quiz', _score, AppConstants.ques.length);
                        ...
                        content: SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "You scored $_score out of ${AppConstants.ques.length}",
