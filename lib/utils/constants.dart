...
import 'package:gyanbuddy/models/animal_model.dart';
import 'package:gyanbuddy/models/bird_model.dart';
import 'package:gyanbuddy/models/itemdata_model.dart';
import 'package:gyanbuddy/models/occupation_model.dart';
import 'package:gyanbuddy/models/season_model.dart';
// ignore: unused_import
import 'package:gyanbuddy/models/number_model.dart';
...
class AppConstants {
  ...
  static List<Module> modules = [
    Module(
      ...
      backgroundColor: const Color.fromARGB(193, 248, 131, 67),
      completionCriteria: CompletionCriteria.quizPassed,
    ),
    Module(
      name: 'A-Z',
      ...
      backgroundColor: const Color.fromARGB(193, 237, 35, 197),
      completionCriteria: CompletionCriteria.quizPassed,
    ),
    Module(
      name: 'Number',
    ...
    Module(
      name: 'Occupations',
      description: 'Learn about occupations',
      thumbnailPath: "assets/images/occupations/occupations.jpeg",
      route: MaterialPageRoute(builder: (context) => OccupationPage()),
      backgroundColor: const Color.fromARGB(255, 243, 178, 43),
      completionCriteria: CompletionCriteria.quizPassed,
    ),
    Module(
      name: 'Seasons',
      description: 'Learn about seasons',
      // thumbnailPath: "assets/seasons/seasons.svg",
      thumbnailPath: "assets/seasons/seasons.png",
      route: MaterialPageRoute(builder: (context) => const SeasonsPage()),
      backgroundColor: const Color.fromARGB(193, 56, 16, 239),
      completionCriteria: CompletionCriteria.quizPassed,
    ),
    Module(
      name: 'Flowers',
      description: 'Explore beauty of natures flower',
      thumbnailPath: AssetsPath.getFlowerImage(Flowers.flowerBanner),
      route: MaterialPageRoute(builder: (context) => BirdsPage()),
      backgroundColor: const Color.fromARGB(193, 234, 15, 216),
      completionCriteria: CompletionCriteria.quizPassed,
    ),
    Module(
      name: 'Solar System',
      description: 'Learn about the solar system',
      thumbnailPath: "assets/images/solar/solar.png",
    ...
    Module(
      ...
      description: 'Explore and buddy about Fruits and Vegetables!',
      thumbnailPath: "assets/fruitsVeges/cover.jpg",
      route: MaterialPageRoute(builder: (context) => BirdsPage()),
      backgroundColor: const Color.fromARGB(193, 107, 255, 98),
      completionCriteria: CompletionCriteria.quizPassed,
    ),
  ];
  ...
  static List<Questions> ques = [
    Questions(
      question: "How many Yellow Cars are there?",
      options: ["5", "6", "1", "2"],
    ...
    Questions(
      ...
      options: ["11", "8", "10", "9"],
      answer: 1, // Index of the correct option, in this case, "10"
    ),
    Questions(
      question: "1,2, _ ,4,5",
      options: ["5", "3", "6", "4"],
      answer: 1, // Index of the correct option, in this case, "3"
    ),
    Questions(
      question: "How many mangoes are there?",
      image: "assets/quiz/q4.jpg",
      options: ["1", "2", "3", "4"],
      answer: 1, // Index of the correct option, in this case, "2"
    ),
    Questions(
    ...
    Questions(
      ...
      options: ["5", "6", "4", "7"],
      answer: 0, // Index of the correct option, in this case, "5"
    ),
    Questions(
      question: "Count Hearts",
      image: "assets/quiz/q7.jpg",
      options: ["10", "6", "9", "7"],
      answer: 3, // Index of the correct option, in this case, "7"
    ),
    Questions(
      question: "Count Buckets",
      image: "assets/quiz/q9.jpg",
      options: ["1", "2", "3", "4"],
      answer: 0, // Index of the correct option, in this case, "1"
    ),
    Questions(
      question: "Count the pencils",
      image: "assets/quiz/q10.jpg",
      options: ["10", "12", "13", "11"],
      answer: 3, // Index of the correct option, in this case, "13"
    ),
  ];
  static List<ItemData> numberItems = [
    ItemData(
      ...
      title: '0',
      description: 'zero',
      backgroundColor: const Color.fromARGB(128, 255, 218, 121),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.one),
      title: '1',
      description: 'one',
      backgroundColor: const Color.fromARGB(128, 146, 208, 255),
    ),
    ItemData(
        iconAsset: AssetsPath.getNumberImage(Numbers.two),
        title: '2',
        description: 'two',
        backgroundColor: const Color.fromARGB(128, 255, 192, 203)),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.three),
      title: '3',
      description: 'three',
      backgroundColor: const Color.fromARGB(128, 240, 255, 146),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.four),
      title: '4',
      description: 'four',
      backgroundColor: const Color.fromARGB(128, 179, 255, 179),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.five),
      title: '5',
      description: 'five',
      backgroundColor: const Color.fromARGB(128, 255, 165, 165),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.six),
      title: '6',
      description: 'six',
      backgroundColor: const Color.fromARGB(128, 128, 255, 255),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.seven),
      title: '7',
      description: 'seven',
      backgroundColor: const Color.fromARGB(128, 255, 255, 128),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.eight),
      title: '8',
      description: 'eight',
      backgroundColor: const Color.fromARGB(128, 165, 165, 255),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.nine),
      title: '9',
      description: 'nine',
      backgroundColor: const Color.fromARGB(128, 255, 128, 128),
    ),
  ];
  static List<ItemData> alphabetItems = [
    ...
    ItemData(
      iconAsset: AssetsPath.getAlphabetImage(Alphabets.sun),
      title: 'S',
    ...
    ItemData(
      iconAsset: AssetsPath.getAlphabetImage(Alphabets.yoyo),
      title: 'Y',
  ...
  static List<Season> seasons = [
    ...
    Season(
      name: 'Monsoon',
      description:
          'The Monsoon is when it rains a lot, making the world look green and beautiful, and helping plants and animals grow.',
      imageAsset: "assets/seasons/rain.svg",
  ...
  static final List<Occupation> occupations = [
    Occupation(
      ...
      svgAsset: "assets/images/occupations/doctor.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/teacher.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/police.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/engineer.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/pilot.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/artist.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/author.svg",
      backgroundColor: Colors.grey.shade300,
    ),
    Occupation(
      name: "Photographer",
      ...
      svgAsset: "assets/images/occupations/photographer.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/vet.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/farmer.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/carpenter.svg",
    ...
    Occupation(
      ...
      svgAsset: "assets/images/occupations/electrician.svg",
      backgroundColor: Colors.lightBlue.shade200,
    ),
    Occupation(
      name: "Barber",
      description: "A barber works in a barbershop and cuts hair.",
      svgAsset: "assets/images/occupations/barber.svg",
      backgroundColor: Colors.lightBlue.shade200,
    ),
    Occupation(
      name: "Dentist",
      ...
      svgAsset: "assets/images/occupations/dentist.svg",
      backgroundColor: Colors.white,
    ),
    Occupation(
      name: "Lawyer",
      ...
      svgAsset: "assets/images/occupations/lawyer.svg",
  ...
  static const String season = 'Seasons';
  static const String description =
      'Interactive app to let your kids buddy various things like\n\n - A - Z alphabets.\n - Animals and their sounds.\n - Birds and their sounds.\n - Various shapes.\n - Body parts.\n - Solar system.\n';
}
